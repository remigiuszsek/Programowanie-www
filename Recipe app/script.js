...
function addMeal(mealData, random = false) {
    ...
    mealsEl.appendChild(meal); //what does appendChild() do?
...
function getMealsLS() {
    const mealIds = JSON.parse(localStorage.getItem('mealIds')); //what is local storage

    
    return mealIds === null ? [] : mealIds;
}

async function fetchFavMeals() { // what does async do
    //clean the container
